...
def rand_zero(maximum = 10, tol = 0):
    ...
    def gen():
        ...
        while((2*b[-16]**2*(b[-11]**2 + b[-14]**2 + b[-15]**2 + b[-16]**2)) == 0 or
           (2*b[-16]*(b[-11]**2 + b[-14]**2 + b[-15]**2 + b[-16]**2)) == 0 or
           b[-16] == 0):
            b = np.array([rand_rational(maximum),
                          rand_rational(maximum),
                          rand_rational(maximum),
        ...
        b[-3] = (-(2*b[-7]*b[-8]*b[-15]**3 +
                   ...
                   b[-15]*b[-16]**4)
                 /(2*b[-16]**2*(b[-11]**2 + b[-14]**2 + b[-15]**2 + b[-16]**2)))
        b[-4] = ((b[-7]*b[-15] - b[-9]*b[-14] + b[-11]*b[-12])
                 /b[-16])
        b[-5] = ((b[-8]*b[-15] - b[-10]*b[-14] + b[-11]*b[-13])
                 /b[-16])
        b[-6] = (-(2*b[-7]*b[-8]*b[-15]**2 +
                   2*b[-7]*b[-8]*b[-16]**2 -
